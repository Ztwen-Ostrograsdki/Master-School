<div>
    ...
    <div class="my-2">
        ...
        <div class="w-100 my-1 d-flex justify-content-end">
            @if($openDynamicStats)
                <span wire:click="$set('openDynamicStats', false)" class="btn btn-info border border-white px-2">
                    <span class="fa fa-filter"></span>
                    <span class="">Fermer l'onglet de stats</span>
                </span>
            @else
                <span wire:click="$set('openDynamicStats', true)" class="btn btn-primary border border-white px-2">
                    <span class="fa fa-filter"></span>
                    <span class="">Avoir la stats d'une évaluation</span>
                </span>
            @endif
        </div>
            @if(!$openDynamicStats)
