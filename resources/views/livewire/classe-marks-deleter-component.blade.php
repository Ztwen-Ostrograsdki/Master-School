<x-z-modal-generator :topPosition="300" :hasHeader="true" :modalHeaderTitle="$title" :width="8" :icon="'fa fa-trash'" :modalName="'classeMarksDeleterModal'" :modalBodyTitle="$title">
    @if($classe || $classe_id)
