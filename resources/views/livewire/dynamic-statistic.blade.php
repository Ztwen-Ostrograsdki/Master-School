<div>
    <div class="p-0 m-0">
        <div class="card container-fluid m-0 p-0 w-100 bg-transparent border border-dark px-2 my-1">
                                ...
                                <div class="info-box-content">
                                    <div class="d-flex justify-content-between">
                                        <form action="" class="w-100 p-2">
                                            ...
                                            <div class="form-group w-100 d-flex justify-content-between">
                                                <input placeholder="Veuillez les différents intervalles de notes à rechercher ..." class="form-control bg-transparent py-1 col-9" type="text" name="intervalles" wire:model.defer="intervalles">
